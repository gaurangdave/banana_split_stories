import json
from api.constants import DEFAULT_THEME, TEXT_MODEL_ID, THEME_CONFIG
...
def _read_mock_story():
    print("🙃 mocking story generation...")

    with open(f"data/adventure.json", "r") as file:
